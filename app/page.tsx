    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative bg-gray-900 text-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-24 md:py-32 relative z-10 flex flex-col justify-center h-full min-h-[600px]">
          <span className="text-emerald-400 font-bold tracking-wider uppercase mb-4">Step Up Your Game</span>
          <h1 className="text-5xl md:text-7xl font-extrabold mb-6 leading-tight">
            Walk with <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-emerald-600">Confidence</span>
          </h1>
          ...
          <div className="flex gap-4">
            ...
            <button className="px-8 py-4 bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/20 text-white rounded-full font-bold transition">
              Learn More
            </button>
          </div>
        </div>
      ...
      <section className="bg-emerald-50 py-12 border-b border-emerald-100">
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          ...
          <div className="p-6 border-l border-r border-emerald-100">
